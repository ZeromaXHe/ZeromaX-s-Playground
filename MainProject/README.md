...
2. 玩家放置积累资源，干预星球文明部分
   1. 月背观察视角下的放置内容。
      ...
      2. 从外星获得支援空投
   2. 视野机制。
      1. 放置侦察探针等机器？或者夺舍或者获取普通人的视角？精神分裂的设定？
   3. 捕获强力人才
      1. 寿命机制？外出任务时正常流逝消耗
   4. 干预局势
      1. 传输带宽或者投放物资先遣队数量限制等，逐步升级放开的设计
3. 游戏外辅助功能
   1. 导入经纬矩形地形图，映射成地图的功能（简易的游戏内编辑？）
...
- [ ] **BUG FIX**：向后移动时，容易出现分块闪现的现象
- [ ] **BUG FIX**：单位移动路径预览时，成本标签不显示



- [x] **重构**：<u>取消全局事件总线的设计，转为获取单例或多例的 Node 的上下文，事件下沉到对应单例</u>
