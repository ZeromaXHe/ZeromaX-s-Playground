...
public class TileRepo : Repository<Tile>, ITileRepo
{
    ...
    public Tile Add(int centerId, int chunkId, Vector3 unitCentroid, List<int> hexFaceIds, List<int> neighborCenterIds) =>
    ...
    public Tile GetByCenterId(int centerId) =>
        _centerIdIndex.TryGetValue(centerId, out var tileId)
